...
final List<Skill> allSkills = [
  ...
  Skill(id: '8', name: 'Shock Shell', image: 's_shell.jpg', vocation: Vocation.raider),

   // code junkie skills
  Skill(id: '9', name: 'Infinit Loop', image: 'i_loop.jpg', vocation: Vocation.junkie),
  Skill(id: '10', name: 'Total Cast', image: 't_cast.jpg', vocation: Vocation.junkie),
  Skill(id: '11', name: 'Encapsulate', image: 'encapsulate.jpg', vocation: Vocation.junkie),
  Skill(id: '12', name: 'Coded Paste', image: 'c_paste.jpg', vocation: Vocation.junkie),

  // ux ninja skills
  Skill(id: '13', name: 'Full Gamify', image: 'gamify.jpg', vocation: Vocation.ninja),
  Skill(id: '14', name: 'Holy Map', image: 'h_map.jpg', vocation: Vocation.ninja),
  Skill(id: '15', name: 'Wireframe', image: 'wireframe.jpg', vocation: Vocation.ninja),
  Skill(id: '16', name: 'Drone Pattern', image: 'd_pattern.jpg', vocation: Vocation.ninja),
];
